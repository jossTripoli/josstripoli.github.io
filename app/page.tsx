...
export default function HomePage() {
  ...
  // roughly: last hero child starts at 0.4s (stagger) and runs 0.6s => ~1.0s total
  const SIGNATURE_DELAY = 1.05
      ...
      <section className="px-6 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            {/* old no writing left to right animation
            <motion.div
              className="space-y-4"
              variants={fadeInUp}
            >
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <Button variant="default" size="icon" asChild className="rounded-full text-primary bg-secondary-purple hover:bg-secondary-purple/90">
